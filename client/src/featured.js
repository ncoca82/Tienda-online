    ...
    render() {
        ...
        <div class="featured">
                ...
                <div class="featured-description">
                    <p>En términos generales, la naturoterapia funciona mediante la utilización de los recursos naturales para estimular y fortalecer los procesos curativos del cuerpo humano.</p>
                </div>
                <div class="featured-items">
                    <div class="featured-item">
                        ...
                        <div class="featured-item-description">
                            <p>La hidroterapia utiliza el agua para relajar el cuerpo y aliviar el dolor muscular, entre otras.</p>
                        </div>
                    </div>
                    <div class="featured-item">
                        <div class="featured-item-image">
                        ...
                        <div class="featured-item-description">
                            <p>la fitoterapia emplea plantas medicinales para tratar dolencias específicas</p>
                        </div>
                    </div>
                    <div class="featured-item">
                        <div class="featured-item-image">
                        ...
                        <div class="featured-item-description">
                            <p> La aromaterapia utiliza aceites esenciales para mejorar el estado de ánimo y aliviar el estrés</p>
                        </div>
                    </div>
                </div>
            </div>
